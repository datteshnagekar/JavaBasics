...
public class BasicArraylistExamples {
	 ...
	 * adding objects into ArrayList, accessing objects based on index, searching an object in ArrayList 
	 * whether it is listed under this instance or not, adding elements at specific index, checking 
	 * whether the ArrayList is empty or not, getting object index, and finally size of the ArrayList.
	 */
